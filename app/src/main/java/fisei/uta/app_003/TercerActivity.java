...
public class TercerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("Tercera Actividad");
        listViewDatos = findViewById(R.id.listViewDatos);
        //cargar datos de prueba en listview
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_expandable_list_item_1,
                cargarDatosListView());
        //asociar el adapter con la vista para mostrar los datos
        listViewDatos.setAdapter(adapter);
         //mostrar el item seleccionado al hacer clic en item
        listViewDatos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(getApplicationContext(), "Item seleccionado:" + itemSelected, Toast.LENGTH_LONG).show();
                //finishAffinity();
